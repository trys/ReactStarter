...
var User = _react2.default.createClass({
  ...
  componentDidMount: function componentDidMount() {
    ...
    fetch('../../data/drivers.json').then(function (response) {
